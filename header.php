...
<html <?php language_attributes(); ?>>
    ...
    <body lang="de" <?php body_class(); ?>>
        <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="page-header text-center">
            <h1>Katrin <span class="sam-color-two font-arial">&amp;</span> Sandra</h1>
            <h2 class="sam-color-two">photo and film</h2>
        </a>
